            ...
            <div class="relative flex-1 px-4 sm:px-6">
              ...
              <div class="absolute inset-0 px-4 sm:px-6">
                <div class="h-full border-2 border-dashed border-gray-200">
                      ...
                      <tr class="border-b border-solid border-gray-400" v-for="(item, index) in selectedItems" :key="index">
                        <td class="py-2 w-1/3">
                          <div class="flex items-center justify-start">
                            <img class="w-16 h-16 rounded-full bg-white object-cover p-2" :src="`${$axios.defaults.baseURL}` + item.image.url" :alt="item.name" />
                  ...
                  <div class="">
                    <button class="relative w-full bg-green-500 py-3 rounded text-green-100 mt-4">
                      Go to Checkout
